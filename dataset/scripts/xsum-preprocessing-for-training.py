'''
generates document, document-lemma, summary files for train, test and validation
'''
...
# ending single and double quote unicode 
...
if __name__ == '__main__':
  parser = argparse.ArgumentParser(description='Preprocess input files')
  parser.add_argument('--tok_dir', type=str, default="./dataset/data/xsum-data-preprocessed", help= "bbs tokenised stories directory")
  parser.add_argument('--out_dir', type=str, default="./dataset/data/xsum-data-topic-convs2s-output", help = "finished files directory")
  parser.add_argument('--split_dict', type=str, default="./dataset/data/XSum-DATA-SPLIT.json")
  parser.add_argument('--lda_word_topics', type=str, default="./dataset/data/lda-train-document-lemma-topic-512-iter-1000/word_term_topics.log")
  args = parser.parse_args()

  bbc_tokenized_stories_dir = args.tok_dir
  finished_files_dir = args.out_dir 
  lda_word_topics = args.lda_word_topics
  split_dict = args.split_dict
  ...
  # TODO: Solve this error, sorting 
  # print(type(wordids))
  # print(wordids)
  # wordids.sort() # Dict keys has no attribute to sort
